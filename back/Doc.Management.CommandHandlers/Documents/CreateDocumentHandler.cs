...
namespace Doc.Management.CommandHandlers.Documents
{
    internal class CreateDocumentHandler : SingleAggregateCommandHandler<CreateDocument, Document>
    {
        ...
        protected override AggregateResult ExecuteCommand(Document aggregate, CreateDocument command, UserId ownerId) => aggregate.Create(command.Key, command.FileNameWithoutExtension, command.Extension, ownerId);
